...
const itemParagraph = document.querySelector(".hero__content-list-item-content p")
...
const itemSpan = document.querySelector(".hero__content-list-item-content p span")
