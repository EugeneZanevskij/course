...
button.addEventListener('click', (event) => {
    ...
    if (!!text && !isNaN(number)) { // делаем проверку, чтобы number был не NaN
        ...
        cardImage.src = 'https://img.freepik.com/psd-gratuit/marque-croix-isolee_23-2151478803.jpg?semt=ais_hybrid&w=740';
        cardImage.width = 20;
